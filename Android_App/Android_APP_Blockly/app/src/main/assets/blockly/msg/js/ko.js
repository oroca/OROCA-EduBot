...
Blockly.Msg["LABEL_IS_MOVING"] = "움직이고 있나?";
Blockly.Msg["LABEL_SET_MAX_VELOCITY"] = "%1을 최대속도로 설정";
Blockly.Msg["LABEL_SET_ACCELERATION"] = "%1을 가속도로 설정";
Blockly.Msg["LABEL_MOVE_SET_STEP"] = "왼쪽 %1 오른쪽 %2 스텝만큼 움직이기";
Blockly.Msg["LABEL_MOVE_SET_VELOCITY"] = "왼쪽 %1 오른쪽 %2 속도로 움직이기";
Blockly.Msg["LABEL_MOVE_SET_DISTANCE"] = "왼쪽 %1 오른쪽 %2 거리만큼 움직이기";
Blockly.Msg["LABEL_MOVE_FORWARD"] = "앞으로 가기";
Blockly.Msg["LABEL_MOVE_BACKWARD"] = "뒤로 가기";
Blockly.Msg["LABEL_MOVE_STOP"] = "정지";
Blockly.Msg["LABEL_TURN_LEFT"] = "왼쪽으로 회전";
Blockly.Msg["LABEL_TURN_RIGHT"] = "오른쪽으로 회전";
Blockly.Msg["LABEL_SLEEP"] = "%1 (ms) 만큼 기다리기";
Blockly.Msg["LABEL_MISC_SET_COLOR"] = "왼쪽 %1 오른쪽 %2 색상 켜기";
Blockly.Msg["LABEL_MISC_TURN_OFF_LEDS"] = "모든 LED 끄기";
Blockly.Msg["LABEL_MISC_SET_TEXT"] = "문자열 출력 %1";
Blockly.Msg["LABEL_MISC_SET_IMAGE"] = "이미지 출력 %1";
Blockly.Msg["LABEL_MISC_CLEAR_DISPLAY"] = "화면 지우기";
Blockly.Msg["LABEL_MISC_GET_BUTTON_STATE"] = "버튼 상태";
Blockly.Msg["LABEL_MISC_IS_BUTTON_PRESSED"] = "버튼이 눌렸는가?";
Blockly.Msg["LABEL_MISC_GET_BATTERY_LEVEL"] = "배터리 전압";
Blockly.Msg["LABEL_MISC_NEED_CHARGING"] = "충전이 필요한가?";
Blockly.Msg["LABEL_SENSOR_FLOOR_SENSOR"] = "바닥센서 %1";
Blockly.Msg["FIELD_LABEL_LEFT_OUTER"] = "왼쪽 바깥";
Blockly.Msg["FIELD_LABEL_LEFT_INNER"] = "왼쪽 안쪽";
Blockly.Msg["FIELD_LABEL_RIGHT_INNER"] = "오른쪽 안쪽";
Blockly.Msg["FIELD_LABEL_RIGHT_OUTER"] = "오른쪽 바깥";
Blockly.Msg["LABEL_SENSOR_DISTANCE_SENSOR"] = "거리센서 %1";
Blockly.Msg["FIELD_LABEL_LEFT"] = "왼쪽";
Blockly.Msg["FIELD_LABEL_RIGHT"] = "오른쪽";
Blockly.Msg["LABEL_SENSOR_IMU_SENSOR"] = "자세센서 %1";
Blockly.Msg["LABEL_SENSOR_ACCELEROMETER"] = "가속도센서 %1";
Blockly.Msg["LABEL_SENSOR_GYRO_SENSOR"] = "각속도센서 %1";
